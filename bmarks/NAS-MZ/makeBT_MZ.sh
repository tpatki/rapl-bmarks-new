...
make -j8 bt-mz CLASS=C NPROCS=6
...
#make -j8 bt-mz CLASS=C NPROCS=34
#make -j8 bt-mz CLASS=C NPROCS=36
#make -j8 bt-mz CLASS=C NPROCS=38
#make -j8 bt-mz CLASS=C NPROCS=40
#make -j8 bt-mz CLASS=C NPROCS=42
#make -j8 bt-mz CLASS=C NPROCS=44
#make -j8 bt-mz CLASS=C NPROCS=46
#make -j8 bt-mz CLASS=C NPROCS=48
